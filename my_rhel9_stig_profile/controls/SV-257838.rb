...
$ sudo dnf install openssl-pkcs11'
  impact 0.5
  tag check_id: 'C-61579r1014826_chk'
  tag severity: 'medium'
  tag gid: 'V-257838'
  tag rid: 'SV-257838r1015080_rule'
  ...
  tag 'documentable'
  tag cci: ['CCI-000765', 'CCI-004046', 'CCI-001953', 'CCI-001954', 'CCI-001948']
  tag nist: ['IA-2 (1)', 'IA-2 (6) (a)', 'IA-2 (12)', 'IA-2 (12)', 'IA-2 (11)']
end
