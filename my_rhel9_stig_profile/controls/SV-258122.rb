...
pam_cert_auth = True'
  impact 0.5
  tag check_id: 'C-61863r1014898_chk'
  tag severity: 'medium'
  tag gid: 'V-258122'
  tag rid: 'SV-258122r1015120_rule'
  ...
  tag 'documentable'
  tag cci: ['CCI-000765', 'CCI-004046', 'CCI-004047', 'CCI-001948']
  tag nist: ['IA-2 (1)', 'IA-2 (6) (a)', 'IA-2 (6) (b)', 'IA-2 (11)']
end
